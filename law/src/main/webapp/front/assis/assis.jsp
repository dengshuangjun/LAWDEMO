	...
	<div class="model">
		...
		<div class="content">
			<div class="left">
				...
				<div class="classify">
					<ul>
						<li class="target"><a href="assis.jsp">法规检索</a></li>
						<li><a href="assis2.jsp">法律e点通</a></li>
						<li><a href="assis3.jsp">法理探索</a></li>
					</ul>
					<ul class="ad">
			...
			<div class="right">
				...
				<div class="news">
					<ul>
						<li><a href="" id="type0">全部</a></li>
						<li><a id="type1" href="#">刑事</a></li>
						<li><a id="type1" href="#">刑事</a></li>
						<li><a id="type1" href="#">刑事</a></li>

					</ul>
					<div class="news_right">
						<div id="news_right_search">
							<label>关键字检索：</label> <input type="text" placeholder="请输入关键字..."
								id="searchKey"> <input type="button" value="检索"
								id="keySearch" onclick="search()">
						</div>
						<ul id="newsInfo">
							<li><a href='#'> 生活设施不安全致害学生的侵权案件</a><label id='date'>2016-08-16</label></li>
							<li><a href='#'> 生活设施不安全致害学生的侵权案件</a><label id='date'>2016-08-16</label></li>
							<li><a href='#'> 生活设施不安全致害学生的侵权案件</a><label id='date'>2016-08-16</label></li>
							<li><a href='#'> 生活设施不安全致害学生的侵权案件</a><label id='date'>2016-08-16</label></li>
							<li><a href='#'> 生活设施不安全致害学生的侵权案件</a><label id='date'>2016-08-16</label></li>
