		...
		<div class="nav_page">
			<ul>
				...
				<li><a href="art.jsp">智慧艺苑</a>
					<ul class="ull">
						<li><a href="art.jsp">法治视频</a></li>
						<li><a href="art2.jsp">法治动漫</a></li>
						<li><a href="art3.jsp">法治摄影</a></li>
						<li><a href="art4.jsp">法治书画</a></li>
						<li><a href="art5.jsp">法治小说</a></li>
					</ul></li>
		...
		<div class="content">
			<div class="left">
				...
				<div class="classify">
					<ul>
						...
						<li><a href="art3.jsp">法治摄影</a></li>
						<li><a href="art4.jsp">法治书画</a></li>
						<li class="target"><a href="art5.jsp">法治小说</a></li>
					</ul>
					<ul class="ad">
			...
			<div class="right">
				...
				<div class="newss">
					<span>法治小说</span>
					<ul id="newsContent">
						<li class="lii"><b style="display: block;">法制视频测试4</b>
							<p>的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v</p>
							<a href="javascript:showMore(1119)">更多>></a></li>
						<li class="lii"><b style="display: block;">法制视频测试4</b>
							<p>的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v的萨芬斯蒂芬v</p>
							<a href="javascript:showMore(1119)">更多>></a></li>
						<li class="lii"><b style="display: block;">法制视频测试4</b>
