...
<body>
	...
	<div id="nav">
		<div class="nav_page">
			<ul>
				...
				<li><a href="wisdom.jsp">智慧讲堂</a>
					<ul class="ull">
						<li><a href="wisdom.jsp">法律时评</a></li>
						<li><a href="wisdom2.jsp">以案释法</a></li>
						<li><a href="wisdom3.jsp">名人说法</a></li>
					</ul></li>
			...
			<div class="left">
				...
				<div class="classify">
					<ul>
						<li><a href="wisdom.jsp">法律时评</a></li>
						<li><a href="wisdom2.jsp">以案释法</a></li>
						<li class="target"><a href="wisdom3.jsp">名人说法</a></li>
	...
	<script type="text/javascript" src="../js/wisdom3.js"></script>
</body>
</html>
