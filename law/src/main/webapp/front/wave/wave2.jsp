		...
		<div class="content">
			<div class="left">
				...
				<div class="classify">
					<ul>
						<li><a href="wave.jsp">校园动态</a></li>
						<li class="target"><a href="wave2.jsp">社会聚焦</a></li>
						<li><a href="wave3.jsp">新闻调查</a></li>
					</ul>
					<ul class="ad">
			...
			<div class="right">
			<div class="head"><span style="color:white;margin-left:5px;padding-top:10px;">校园动态</span></div>
			<div class="news">	
                <div class="newsbox">
                	<div class="new_left">
                		<ul>
                		...
                		<p style="text-align:center;margin-top:10px;"><div class="tcdPageCode"></div>
                	</div>
                	<div class="new_right">
                		<img src="../images/cui.png" class="img1">
                		<img src="../images/icon.jpg" class="img2">
                	</div>
                </div>
			</div>
		</div>
