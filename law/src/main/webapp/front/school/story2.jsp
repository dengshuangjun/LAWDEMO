			...
			<div class="left">
				...
				<div class="classify">
					<ul>
						<li><a href="people.jsp">法治名人</a></li>
						<li><a href="story.jsp">法治故事</a></li>
						<li class="target"><a href="story2.jsp">法治典故</a></li>
						<li><a href="saying.jsp">法治名言</a></li>
						<li><a href="secret.jsp">法治灯谜</a></li>
						<li><a href="words.jsp">法治楹联</a></li>
					</ul>
