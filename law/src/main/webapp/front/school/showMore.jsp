		...
		<div class="content">
			...
			<div class="right">
				<div class="right_top">
					...
					<p style="margin:3px 250px">发表日期:${Detail.ndate}&nbsp;&nbsp;&nbsp;作者：${Detail.author}&nbsp;&nbsp;&nbsp;浏览次数：${Detail.views}</p>
					<hr/>
					<div class="ppp">
						
					<li style="margin-left:150px;"><img src="../../${Detail.picpath} " width="400" height="300"alt="${Detail.title}"></li>
					...
					<div class="right_low_right">
						<form >
							<textarea name="remark"
								style="width: 260px; height: 100px; margin-left: 20px; margin-top: 20px; resize: none;">
						
						</textarea>
							<br /> <label style="margin-left: 20px; margin-top: 20px;">还可以输入20个字</label>
							<button style="margin-left: 180px; margin-top: 20px;">发表评论</button>
						</form>
					</div>
				</div>
